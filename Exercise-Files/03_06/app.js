/* This is first module -> 
		1st parameter is the name of the module(myApp) and the 2nd parameter is array of the modules as dependencies
*/
...
// we have to create our dependencies in the module so that the injector will be able to find it. So we can write my app dog factory to create our first solver's.
...
// START->
// first dependency = 2 parameters-> 1st name of dependency and the 2nd parameter is the function
...
// here we inject dependency into controller
